...
CDlgQuickViewer::CDlgQuickViewer(CWnd* pParent) : CDialogEx(CDlgQuickViewer::IDD, pParent)
{
	m_ParentCDC = NULL;
}


CDlgQuickViewer::CDlgQuickViewer(CDC* pDC, CWnd* pParent) : CDialogEx(CDlgQuickViewer::IDD, pParent)
{
	m_ParentCDC = pDC;
}
